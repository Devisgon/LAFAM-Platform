...
export const DEFAULT_BOOKING_PHONE_COUNTRY_CODE = KUWAIT_PHONE_CODE;
export const BOOKING_PHONE_PATTERN = /^\+[1-9]\d{6,15}$/u;
export const BOOKING_EMAIL_PATTERN = /^[^\s@]+@[^\s@]+\.[^\s@]+$/u;

export const BOOKING_PHONE_COUNTRY_CODES = [
