...
export function CreateActionBar({
  ...
  return (
    <header className="flex min-h-22 items-center justify-between gap-4 rounded-md bg-card-bg-primary px-5 shadow-lg shadow-slate-900/10 md:px-6">
      ...
      <a
        className="inline-flex min-h-12 items-center rounded-sm bg-button-primary px-5 text-base font-semibold text-white transition hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
        href={actionHref}
      >
        {actionLabel}
      </a>
